...
var ran = document.getElementById("ran"); //slider value
var rectcontainer;
var timeout = 25;
var choice = 5;
...
function anim() {
    for (let i = 0; i < +ran.value; i += 10) {
        var R = new Rect(50 + i, 0, rand(50, 400), context);
        R.draw("#f9b384");
...
function selectsort() {
    ...
    function recurSelectionSort(a, n, index) {
...
function disable_button(button_number) {
    ...
    var b5 = document.getElementById("ran");
    if (button_number == 0) {
        b1.disabled = false;
        b2.disabled = false;
        b3.disabled = false;
